import styles from '../../styles/crypto/Coins.module.css'
const Coins = ({ name, key, price, symbol, marketcap, volume, image, priceChange }) => {
    return (
        <div className={styles.coin__container}>
            <div className={styles.coin__row}>
                ...
                <div className={styles.coin__data}>
                    ...
                    <p className={styles.coin__volume}>vol.  $ {volume}</p>
                    {priceChange < 0 ? (
